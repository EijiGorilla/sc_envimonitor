...
import '../App.css';
import { generateChartData, generateTotalNumber, thousands_separators } from '../Query';
  ...
  useEffect(() => {
    ...
    function makeSeries(name: any, fieldName: any) {
      ...
      series.columns.template.events.on('click', (ev) => {
        ...
        const sqlExpression = 'Type = ' + typeSelect + ' AND ' + 'Status = ' + selectedStatus;
        ...
        view.when(() => {
          ...
          view.whenLayerView(monitorPointLayer).then((layerView: any) => {
      ...
      <div className="totalProgressDiv">
        <div>
          ...
          <b className="totalExceedNumber">
            ...
            <div className="totalNumber">({thousands_separators(totalNumber[0])})</div>
          </b>
        </div>
        <img
          src={
